...
class TestInterviewAI:
    ...
    def test_camera_validation(self):
        ...
        is_valid = (camera_status["camera_on"] and 
                   camera_status["face_detected"] and 
                   not camera_status["multiple_faces"])
    ...
    def test_behavior_monitoring(self):
        ...
        is_suspicious = (
            behavior_data["tab_switches"] > 3 or
            behavior_data["looking_away_count"] > 10 or
            not behavior_data["face_visible"]
        )
